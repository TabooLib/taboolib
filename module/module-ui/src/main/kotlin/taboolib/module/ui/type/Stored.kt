...
open class Stored(title: String) : Basic(title) {
    ...
    open class Rule {
        ...
        /** 写入物品回调 **/
        internal var writeItem: ((inventory: Inventory, itemStack: ItemStack, slot: Int, click: org.bukkit.event.inventory.ClickType) -> Unit) = { inventory, item, slot, _ ->
         ...
         * 物品写入回调
         */
        open fun writeItem(writeItem: (inventory: Inventory, itemStack: ItemStack, slot: Int, click: org.bukkit.event.inventory.ClickType) -> Unit) {
