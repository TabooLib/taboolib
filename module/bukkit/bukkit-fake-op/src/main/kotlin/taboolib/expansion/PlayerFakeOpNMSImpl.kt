    ...
    class PlayerFakeOpUtil {
        ...
        init {
            ...
            val dynamicType = ByteBuddy()
                ...
                .withParameters(CraftServer::class.java, nmsClass("EntityPlayer"), CraftPlayer::class.java)
                .intercept(
                    MethodCall.invoke(CraftPlayer::class.java.getDeclaredConstructor(CraftServer::class.java, nmsClass("EntityPlayer")))
                        .withArgument(0, 1)
            ...
            playerFakeOpConstructor = playerFakeOpClass.getConstructor(CraftServer::class.java, nmsClass("EntityPlayer"), CraftPlayer::class.java)
        }
