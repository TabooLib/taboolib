package taboolib.module.ui.linked;

import com.google.common.collect.Maps;
import org.bukkit.Material;
import taboolib.common.Isolated;
import taboolib.common.util.UtilKt;
...
public abstract class MenuLinked<T> {
    ...
    public void open(int page) {
        ...
        this.items = UtilKt.subList(itemsAll, page * slots.size(), (page + 1) * slots.size() - 1);
        MenuBuilder.builder()
                .lockHand(isLockHand())
                .title(getTitle())
                .rows(getRows())
    ...
    public boolean hasNextPage() {
        return next(page, itemsAll.size(), slots.size());
    }
