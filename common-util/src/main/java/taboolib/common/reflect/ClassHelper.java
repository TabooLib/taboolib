 ...
 * {@code [I}. </p>
 * <p>
 * 原名为 ClassUtils，为避免混淆改名为 ClassHelper。
 * 修改 Class.forName，使其指向 TabooLib.getClass。
 *
 * @since 2.0
 */
public class ClassHelper {
    ...
    public static Class<?> getClass(
        ...
        try {
            ...
            if (namePrimitiveMap.containsKey(className)) {
                ...
                clazz = TabooLib.getClass(toCanonicalName(className), initialize, classLoader);
            }
            return clazz;
    ...
    public static Class<?> getClass(final String className, final boolean initialize) throws ClassNotFoundException {
        ...
        final ClassLoader loader = contextCL == null ? ClassHelper.class.getClassLoader() : contextCL;
    ...
    public static String getShortCanonicalName(final String canonicalName) {
        return ClassHelper.getShortClassName(getCanonicalName(canonicalName));
    }
    ...
    public static String getPackageCanonicalName(final String canonicalName) {
        return ClassHelper.getPackageName(getCanonicalName(canonicalName));
    }
