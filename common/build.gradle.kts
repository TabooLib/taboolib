...
dependencies {
    ...
    implementation("org.tabooproject.reflex:reflex:1.0.15")
    implementation("org.tabooproject.reflex:analyser:1.0.15")
}
...
tasks {
    withType<ShadowJar> {
        ...
        dependencies {
            ...
            include(dependency("org.tabooproject.reflex:reflex:1.0.15"))
            include(dependency("org.tabooproject.reflex:analyser:1.0.15"))
        }
