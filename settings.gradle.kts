...
include("platform:platform-sponge-api7:platform-sponge-api7-adapter")
include("platform:platform-sponge-api7:platform-sponge-api7-command")
include("platform:platform-sponge-api7:platform-sponge-api7-core")
include("platform:platform-sponge-api7:platform-sponge-api7-event")
include("platform:platform-sponge-api7:platform-sponge-api7-listener")
include("platform:platform-sponge-api7:platform-sponge-api7-openapi")
include("platform:platform-sponge-api7:platform-sponge-api7-plugin")
include("platform:platform-sponge-api7:platform-sponge-api7-scheduler")

// platform-sponge-api8
include("platform:platform-sponge-api8:platform-sponge-api8-adapter")
include("platform:platform-sponge-api8:platform-sponge-api8-command")
include("platform:platform-sponge-api8:platform-sponge-api8-core")
include("platform:platform-sponge-api8:platform-sponge-api8-event")
include("platform:platform-sponge-api8:platform-sponge-api8-listener")
include("platform:platform-sponge-api8:platform-sponge-api8-openapi")
include("platform:platform-sponge-api8:platform-sponge-api8-plugin")
