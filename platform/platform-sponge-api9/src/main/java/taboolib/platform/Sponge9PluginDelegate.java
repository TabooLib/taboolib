...
import static taboolib.platform.Sponge9Plugin.getPluginInstance;

public class Sponge9PluginDelegate {

	private final Class<?> pluginClass;
	private final Field pluginInstance;


	public Sponge9PluginDelegate() throws ClassNotFoundException, NoSuchFieldException {
		this.pluginClass = Class.forName("taboolib.platform.Sponge9Plugin");
