...
import static taboolib.platform.CloudNetV3Plugin.getPluginInstance;

public class CloudNetV3PluginDelegate {

	private final Class<?> pluginClass;
	private final Field pluginInstance;


	public CloudNetV3PluginDelegate() throws ClassNotFoundException, NoSuchFieldException {
		this.pluginClass = Class.forName("taboolib.platform.CloudNetV3Plugin");
