...
import static taboolib.platform.Sponge8Plugin.getPluginInstance;

public class Sponge8PluginDelegate {

	private final Class<?> pluginClass;
	private final Field pluginInstance;


	public Sponge8PluginDelegate() throws ClassNotFoundException, NoSuchFieldException {
		this.pluginClass = Class.forName("taboolib.platform.Sponge8Plugin");
